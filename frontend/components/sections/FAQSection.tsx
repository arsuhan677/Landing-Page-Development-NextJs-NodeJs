  ...
  const faqs = [
    {
      ...
      answer:
        "হ্যাঁ, আমাদের Vitamin C Serum সব ধরনের স্কিনের জন্য উপযুক্ত। তবে সেনসিটিভ স্কিনের জন্য প্রথমে অল্প পরিমাণে প্যাচ টেস্ট করে নেওয়া ভালো।",
    },
    {
      question: "কত দিনে ফলাফল দেখতে পাবো?",
      answer:
        "নিয়মিত ব্যবহারে সাধারণত ২-৪ সপ্তাহের মধ্যে ত্বকের উজ্জ্বলতা এবং পরিবর্তন লক্ষ্য করা যায়।",
    },
    {
      question: "দিনে কয়বার ব্যবহার করব?",
      answer:
        "সেরা ফলাফলের জন্য প্রতিদিন রাতে একবার ব্যবহার করার পরামর্শ দেওয়া হয়।",
    },
    {
      question: "এটা কি প্রেগন্যান্সিতে নিরাপদ?",
      answer:
        "আমাদের পণ্য প্রাকৃতিক উপাদান দিয়ে তৈরি, তবে প্রেগন্যান্সির সময় যেকোনো নতুন প্রোডাক্ট ব্যবহারের আগে ডাক্তারের পরামর্শ নেয়া ভালো।",
    },
    {
    ...
    },
    {
      ...
      answer:
        "ঢাকা সিটির ভেতরে ১-২ দিন এবং ঢাকার বাইরে ৩-৫ দিনের মধ্যে ডেলিভারি সম্পন্ন করা হয়।",
    },
    {
      question: "প্রোডাক্ট কি অরিজিনাল?",
      answer:
        "জি, আমরা ১০০% অরিজিনাল এবং সার্টিফাইড প্রোডাক্টের গ্যারান্টি দিচ্ছি।",
    },
  ];

  return (
    <section id="#FAQ" className="bg-[#FFF5ED] py-16">
