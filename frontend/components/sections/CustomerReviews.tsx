      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <div className="flex gap-2">
            <button className="bg-[#F37021] text-white px-6 py-2 rounded-full text-sm font-medium">
              সব রিভিউ
            </button>
            <button className="bg-white text-gray-600 px-6 py-2 rounded-full text-sm font-medium border border-gray-100">
              ফটো সহ
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-white rounded-[2rem] p-6 shadow-sm relative overflow-hidden flex flex-col"
            >
              {/* Rating */}
