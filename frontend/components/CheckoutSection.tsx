...
//               <input type="text" placeholder="নাম *" className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-[#F37021]" required />
//               <input type="tel" placeholder="মোবাইল নাম্বার * (01XXXXXXXXX)" className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-[#F37021]" required />
//               <input type="text" placeholder="সম্পূর্ণ ঠিকানা *" className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-[#F37021]" required />
//               <input type="text" placeholder="জেলা/থানা *" className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-[#F37021]" required />
//               <textarea placeholder="নোট (ঐচ্ছিক, সর্বোচ্চ ৫০০ অক্ষর)" className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl h-24 focus:outline-[#F37021]"></textarea>

//               {/* Quantity Selector */}
//               <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
//                 <span className="font-bold text-[#333]">পরিমাণ</span>
//                 <div className="flex items-center gap-4">
//                   <button type="button" onClick={() => setQuantity(q => q > 1 ? q - 1 : 1)} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors">
//                     <Minus size={16} />
//                   </button>
//                   <span className="font-bold text-lg">{quantity}</span>
//                   <button type="button" onClick={() => setQuantity(q => q + 1)} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors">
//                     <Plus size={16} />
//                   </button>
//                 </div>
//               </div>
...
//               <button type="submit" className="w-full bg-[#F37021] hover:bg-orange-600 text-white font-bold py-5 rounded-xl shadow-lg shadow-orange-200 transition-all active:scale-[0.98] uppercase tracking-wide">
//                 অর্ডার কনফার্ম করুন
//               </button>
            ...
            <form className="space-y-4" onSubmit={handleConfirm}>
              ...
              {/* {saving && (
                <p className="text-green-600 text-sm mt-2">
                  Form auto-saving pending order...
                </p>
              )} */}
